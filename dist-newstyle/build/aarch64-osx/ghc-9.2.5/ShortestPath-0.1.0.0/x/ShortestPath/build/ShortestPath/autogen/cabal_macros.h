...
/* package ShortestPath-0.1.0.0 */
#ifndef VERSION_ShortestPath
#define VERSION_ShortestPath "0.1.0.0"
#endif /* VERSION_ShortestPath */
#ifndef MIN_VERSION_ShortestPath
#define MIN_VERSION_ShortestPath(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_ShortestPath */
...
#define CURRENT_COMPONENT_ID "ShortestPath-0.1.0.0-inplace-ShortestPath"
